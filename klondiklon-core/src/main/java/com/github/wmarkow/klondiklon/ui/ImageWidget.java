...
public class ImageWidget extends Image
{
    ...
    public void draw(Batch batch, float parentAlpha)
    {
        ...
        float x = getX();
        float y = getY();
        float scaleX = 1f;//getScaleX();
        float scaleY = 1f;//getScaleY();
    ...
    {
        if (drawable != null)
            return drawable.getMinWidth() * getScaleX();
        return 0;
    }
    ...
    {
        if (drawable != null)
            return drawable.getMinHeight() * getScaleY();
        return 0;
    }
