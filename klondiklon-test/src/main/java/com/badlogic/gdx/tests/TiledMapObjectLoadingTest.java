...
public class TiledMapObjectLoadingTest extends GdxTest
{
    ...
    public void create()
    {
        ...
        // Test get objects by type (adding circle manually because it doesn't exists in
        // Tiledmap editor)
        ...
        for (MapObject mapObject : layer.getObjects())
        {
            ...
            if (mapObject instanceof TiledMapTileMapObject)
            {
                ...
                batch.draw(textureRegion, xPos, yPos, tmtObject.getOriginX() * scaleX, tmtObject.getOriginY() * scaleY,
                        textureRegion.getRegionWidth() * scaleX, textureRegion.getRegionHeight() * scaleY, 1f, 1f,
                        rotation);
    ...
    public static void main(String[] arg)
    {
        ...
        new LwjglApplication(new TiledMapObjectLoadingTest(), config);
    }
}
